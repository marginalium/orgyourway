...
final class Version20220918153440 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE tickets (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, event_id INT DEFAULT NULL, source VARCHAR(255) NOT NULL, external_ticket_id VARCHAR(255) DEFAULT NULL, gross_revenue_in_cents INT DEFAULT NULL, ticket_revenue_in_cents INT DEFAULT NULL, third_party_fees_in_cents INT DEFAULT NULL, third_party_payment_processing_in_cents INT DEFAULT NULL, tax_in_cents INT DEFAULT NULL, quantity INT NOT NULL, payment_type VARCHAR(255) DEFAULT NULL, payment_status VARCHAR(255) DEFAULT NULL, delivery_method VARCHAR(255) DEFAULT NULL, checked_in TINYINT(1) NOT NULL, checked_in_at DATETIME DEFAULT NULL, purchased_at DATETIME DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, deleted_at DATETIME DEFAULT NULL, INDEX IDX_54469DF4A76ED395 (user_id), INDEX IDX_54469DF471F7E88B (event_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
