...
final class Version20220916023546 extends AbstractMigration
{
    ...
    {
        return 'Initial setup and creation of events, tickets, and users tables';
    }

    public function up(Schema $schema): void
    {
        // this up() migration is auto-generated, please modify it to your needs
        $this->addSql('CREATE TABLE events (id INT AUTO_INCREMENT NOT NULL, event_name VARCHAR(255) NOT NULL, attendance_cap INT DEFAULT NULL, ticket_cost_in_cents INT DEFAULT NULL, started_at DATETIME NOT NULL, ended_at DATETIME NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, deleted_at DATETIME DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE tickets (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, event_id INT DEFAULT NULL, source VARCHAR(255) NOT NULL, external_ticket_id VARCHAR(255) NOT NULL, gross_revenue_in_cents INT NOT NULL, ticket_revenue_in_cents INT NOT NULL, third_party_fees_in_cents INT NOT NULL, third_party_payment_processing_in_cents INT NOT NULL, tax_in_cents INT NOT NULL, quantity INT NOT NULL, payment_type VARCHAR(255) NOT NULL, payment_status VARCHAR(255) NOT NULL, delivery_method VARCHAR(255) NOT NULL, checked_in TINYINT NOT NULL DEFAULT FALSE, purchased_at DATETIME NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, deleted_at DATETIME DEFAULT NULL, INDEX IDX_54469DF4A76ED395 (user_id), INDEX IDX_54469DF471F7E88B (event_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
